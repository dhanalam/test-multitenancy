        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('tenant.projects.update', ['tenant' => tenant('id'), 'project' => $project]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active', $project->is_active) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="order_no" class="block mt-1 w-full" type="number" name="order_no" :value="old('order_no', $project->order_no)" min="0" />
                        ...
                        <div class="mb-4">
                            ...
                            @foreach ($languages as $language)
                                <div class="p-4 mb-4 border rounded-md">
                                    ...
                                    @php
                                        $translation = $project->getTranslation($language->id);
                                    @endphp
